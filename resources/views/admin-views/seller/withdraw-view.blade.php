...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{trans('messages.seller')}} {{trans('messages.Withdraw')}}</li>
        </ol>
    </nav>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-8 mt-2">
                        ...
                        <h4>{{trans('messages.bank_name')}}: {{$seller->seller->bank_name ? $seller->seller->bank_name : 'No Data found'}}</h4>
                        <h6>{{trans('messages.Branch')}}  : {{$seller->seller->branch ? $seller->seller->branch : 'No Data found'}}</h6>
                        <h6>{{trans('messages.holder_name')}} : {{$seller->seller->holder_name ? $seller->seller->holder_name : 'No Data found'}}</h6>
                        <h6>{{trans('messages.account_no')}}  : {{$seller->seller->account_no ? $seller->seller->account_no : 'No Data found'}}</h6>
    ...
    <div class="row mt-3" >
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5>{{trans('messages.amount')}} : {{$seller->amount}}</h5>
                    ...
                    @if($seller->approved==1)
                        <label class="badge badge-success p-2 rounded-bottom">{{trans('messages.Approved')}}</label>
                    @else
                        <label class="badge badge-danger p-2 rounded-bottom">{{trans('messages.Denied')}}</label>
                    @endif
